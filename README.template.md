...
|---------|-------------|-------|
| **[crucible_framework](https://github.com/North-Shore-AI/crucible_framework)** | Documentation hub & research framework | ⭐ {{STARS:crucible_framework}} |
| **[crucible_bench](https://github.com/North-Shore-AI/crucible_bench)** | Statistical testing & analysis (15+ tests, effect sizes, power analysis) | ⭐ {{STARS:crucible_bench}} |
| **[crucible_ensemble](https://github.com/North-Shore-AI/crucible_ensemble)** | Multi-model voting strategies for improved reliability | ⭐ {{STARS:crucible_ensemble}} |
| **[crucible_hedging](https://github.com/North-Shore-AI/crucible_hedging)** | Request hedging for latency reduction | ⭐ {{STARS:crucible_hedging}} |
| **[crucible_trace](https://github.com/North-Shore-AI/crucible_trace)** | Causal reasoning chain logging for LLM transparency | ⭐ {{STARS:crucible_trace}} |
| **[crucible_datasets](https://github.com/North-Shore-AI/crucible_datasets)** | Unified interface to benchmark datasets (MMLU, HumanEval, GSM8K) | ⭐ {{STARS:crucible_datasets}} |
| **[crucible_telemetry](https://github.com/North-Shore-AI/crucible_telemetry)** | Research-grade instrumentation & metrics collection | ⭐ {{STARS:crucible_telemetry}} |
| **[crucible_harness](https://github.com/North-Shore-AI/crucible_harness)** | Automated experiment orchestration & reporting | ⭐ {{STARS:crucible_harness}} |

### In-Progress Extensions

| Library | Description | Stars |
|---------|-------------|-------|
| **[crucible_adversary](https://github.com/North-Shore-AI/crucible_adversary)** | Adversarial testing & robustness evaluation framework | ⭐ {{STARS:crucible_adversary}} |
| **[crucible_xai](https://github.com/North-Shore-AI/crucible_xai)** | Explainable AI tools (LIME, SHAP, feature attribution) | ⭐ {{STARS:crucible_xai}} |
| **[ExDataCheck](https://github.com/North-Shore-AI/ExDataCheck)** | Data validation & quality library for ML pipelines | ⭐ {{STARS:ExDataCheck}} |
| **[ExFairness](https://github.com/North-Shore-AI/ExFairness)** | Fairness & bias detection library for AI/ML systems | ⭐ {{STARS:ExFairness}} |
| **[LLMGuard](https://github.com/North-Shore-AI/LlmGuard)** | AI firewall & guardrails for LLM-based applications | ⭐ {{STARS:LlmGuard}} |
...
- **[claude_code_sdk_elixir](https://github.com/nshkrdotcom/claude_code_sdk_elixir)** ⭐ {{STARS:claude_code_sdk_elixir}} - An Elixir SDK for Claude Code - provides programmatic access to Claude Code CLI with streaming message processing
